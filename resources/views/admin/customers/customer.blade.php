                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block">
                        <div class="me-auto mb-sm-0 mb-3">
                            <h4 class="card-title mb-2">Customer Account Management</h4>
                        ...
                        <div class="container">
                            <form action="{{url('admin/customers')}}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 mt-3">
                                            <label class="text-black font-w600 form-label">Social Media Link <span
                                                    class="required text-danger">*</span></label>
                                            <input type="text" class="form-control form-control-sm"
                                                id="social_media_link" placeholder="Enter Social Media Link"
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 mt-3">
                                            <label class="text-black font-w600 form-label">Mobile No <span
                                                    class="required text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 mt-3">
                                            <label class="text-black font-w600 form-label">Country <span
                                                    class="required text-danger">*</span></label>
                                            <select id="single-select" class="form-select" name="country">
