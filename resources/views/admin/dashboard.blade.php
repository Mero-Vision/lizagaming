...
<body>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
				...
				<div class="copyright">
					<p><strong>Zenix Crypto Admin Dashboard</strong> © 2023 All Rights Reserved</p>
								...
								<div class="card">
									<div class="card-header d-sm-flex d-block pb-0 border-0">
										...
										<select class="form-control custom-image-select image-select mt-3 mt-sm-0">
											<option data-thumbnail="images/svg/ltc.svg">Yearly (2023)</option>
											<option data-thumbnail="images/svg/eth.svg">Weekly (2023)</option>
											<option data-thumbnail="images/svg/btc.svg">Daily (2023)</option>
										</select>
									</div>
									<div class="card-body">
    ...
    ***********************************-->
	...
	<!-- Apex Chart -->
	<script src="{{ url('assets/js/apexchart.js')}}"></script>
