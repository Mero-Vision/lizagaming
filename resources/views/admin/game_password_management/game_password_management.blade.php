                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block">
                        <div class="me-auto mb-sm-0 mb-3">
                            <h4 class="card-title mb-2">Game Account Passwords Listing</h4>
                            <span>Password Management</span>
                        </div>

                        <a href="javascript:void(0);" class="btn btn-info" data-bs-toggle="modal"
                            data-bs-target="#myModal">+ Add New Account</a>
                    </div>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ url('admin/game-password-management') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 mt-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Eg: Firekirin"
                                                        name="name">
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3 mt-3">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        placeholder="Eg: firekirin.com" name="url">
                                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex action-button">
                                                    ...
                                                    <a href="{{url('admin/game-password-management')}}/{{$data->id}}"
